...
BWIPJS.bwipp["databarlimitedcomposite"]=function() {
	...
	function $f0(){
		//#line 16087: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 16088: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 16090: currentdict end /options exch def
	...
	function $f5(){
		//#line 16092: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 16096: /linear exch def
		this.stk[this.ptr++]="linear"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16097: pop
		this.ptr--;
		//#line 16098: /comp exch def
	...
	function $f8(){
		//#line 16118: 1 linsbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
		this.stk[this.ptr++]=1;
	}
	function $f9(){
		//#line 16118: 1 linsbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
	...
	//#line 16076: 20 dict begin            % Confine variables to local scope
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 16078: /options exch def
	this.stk[this.ptr++]="options"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16079: /barcode exch def
	this.stk[this.ptr++]="barcode"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16081: /dontdraw false def
	this.stk[this.ptr++]="dontdraw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16084: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16103: gsave
	this.gsave();
	//#line 16105: options (lintype) (databarlimited) put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16106: options (linkage) true put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16107: options (inkspread) (0) put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16108: options (dontdraw) true put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16111: linear options //databarlimited exec
	...
	//#line 16112: dup (sbs) get /linsbs exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16113: dup (bhs) get 0 get 72 mul /linheight exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	//#line 16119: counttomark 1 sub array astore /sep exch def pop pop
	...
	this.ptr--;
	this.ptr--;
	//#line 16120: sep 0 [0 0 0] putinterval
	...
	//#line 16121: sep sep length 4 sub [0 0 0 0] putinterval
	var t=this.dstk.get("sep");
	if (t===undefined) throw new Error("dict: sep: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("sep");
	...
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 16122: 0 linheight rmoveto <<
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr++]=1;
	//#line 16127: /height 1 72 div
	this.stk[this.ptr++]="height"; //ident
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16128: /width sep length 72 div
	...
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16129: /opt options
	this.stk[this.ptr++]="opt"; //ident
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 16130: >> //renmatrix exec
	var t = {};
	...
	var t=this.stk[--this.ptr];
	if (t instanceof Function) t.call(this); else this.eval(t);
	//#line 16133: comp options //gs1-cc exec 
	...
	var t=this.stk[--this.ptr];
	if (t instanceof Function) t.call(this); else this.eval(t);
	//#line 16134: dup (pixx) get 72 exch sub 1 rmoveto 
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
