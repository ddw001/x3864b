...
BWIPJS.bwipp["code49"]=function() {
	...
	function $f0(){
		//#line 9602: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 9603: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 9605: currentdict end /options exch def
	...
	function $f5(){
		//#line 9607: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 9622: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		//#line 9623: length j add 1 add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t===undefined) throw new Error("dict: j: undefined");
		...
		//#line 9624: pop
		this.ptr--;
		//#line 9625: dup 0 3 getinterval cvi msg exch j 1 sub exch put
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=3;
		...
		this.ptr-=3;
		//#line 9626: dup length 3 sub 3 exch getinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		this.stk[this.ptr++]=3;
	...
	function $f7(){
		//#line 9628: dup msg exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("msg");
		if (t===undefined) throw new Error("dict: msg: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 9629: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t===undefined) throw new Error("dict: j: undefined");
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9630: /barcode msg 0 j getinterval def
	...
	function $f9(){
		//#line 9617: /msg barcode length string def
	...
	function $f10(){
		//#line 9647: i barlen eq {exit} if
		return -1;
	}
	function $f11(){
		//#line 9651: /char fncvals barcode i 1 add 4 getinterval get def
	...
	function $f13(){
		//#line 9650: barcode i 1 add get 94 ne {
		var t=this.dstk.get("barcode");
		if (t===undefined) throw new Error("dict: barcode: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f14(){
		...
		//#line 9648: /char barcode i get def
		this.stk[this.ptr++]="char"; //ident
		var t=this.dstk.get("barcode");
		if (t===undefined) throw new Error("dict: barcode: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9649: parsefnc char 94 eq and i barlen 4 sub lt and {
	...
	function $f15(){
		//#line 9678: dup type /stringtype eq {0 get} if  % convert string to ASCII if required
		this.stk[this.ptr++]=0;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
		else this.stk[this.ptr-2]=this.stk[this.ptr-2][this.stk[this.ptr-1].toString()];
	...
	function $f16(){
		//#line 9676: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9677: charmap i get 
	...
	function $f17(){
		//#line 9697: charvals i [ charvals s1 get charvals c2 get ] put
		var t=this.dstk.get("charvals");
		if (t===undefined) throw new Error("dict: charvals: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f18(){
		//#line 9700: charvals i [ charvals s2 get charvals c2 get ] put
		var t=this.dstk.get("charvals");
		if (t===undefined) throw new Error("dict: charvals: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f19(){
		//#line 9694: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9695: combos i get dup 0 get /c1 exch def 1 get /c2 exch def
	...
	function $f20(){
		//#line 9706: dup type /arraytype ne {1 array astore} if
		this.stk[this.ptr++]=1;
	...
	function $f21(){
		...
		//#line 9707: dup cws exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 9708: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t===undefined) throw new Error("dict: j: undefined");
	...
	function $f22(){
		//#line 9712: 0 exch {48 sub exch 10 mul add} forall
	...
	function $f23(){
		//#line 9713: [ 3 1 roll exch 1 sub {dup 48 mod exch 48 idiv} repeat ]
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f24(){
		//#line 9714: [ exch dup length 1 sub -1 0 {1 index exch get exch} for pop ]
		this.stk[this.ptr++]=1;
	...
	function $f25(){
		...
		this.ptr = i;
		this.stk[this.ptr++]=BWIPJS.psarray(t);
		//#line 9715: dup cws exch j exch putinterval
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		var t=this.dstk.get("cws");
		if (t===undefined) throw new Error("dict: cws: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 9716: length j add /j exch def
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		var t=this.dstk.get("j");
		if (t===undefined) throw new Error("dict: j: undefined");
	...
	function $f26(){
		//#line 9721: /pre nums length dup 5 mod dup 2 ne {sub} {sub 5 sub} ifelse def
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f27(){
		//#line 9721: /pre nums length dup 5 mod dup 2 ne {sub} {sub 5 sub} ifelse def
	...
	function $f28(){
		//#line 9722: 0 5 pre 1 sub {nums exch 5 getinterval 3 exch base48} for
	...
	function $f29(){
		//#line 9725: dup 1 eq {nums i get encodealpha} if
		var t=this.dstk.get("nums");
		if (t===undefined) throw new Error("dict: nums: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f30(){
		//#line 9726: dup 3 eq {2 nums base48} if
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("nums");
		if (t===undefined) throw new Error("dict: nums: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f31(){
		//#line 9727: dup 4 eq {3 [49 48 nums aload pop] base48} if
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=49;
		this.stk[this.ptr++]=48;
	...
	function $f32(){
		//#line 9729: 3 [49 48 nums 0 4 getinterval aload pop] base48
		this.stk[this.ptr++]=3;
		this.stk[this.ptr++]=Infinity;
		this.stk[this.ptr++]=49;
		this.stk[this.ptr++]=48;
		...
		if (t===undefined) throw new Error("dict: base48: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 9730: 2 nums 4 3 getinterval base48
		this.stk[this.ptr++]=2;
		var t=this.dstk.get("nums");
		if (t===undefined) throw new Error("dict: nums: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f33(){
		...
		//#line 9723: /nums nums pre nums length pre sub getinterval def
		this.stk[this.ptr++]="nums"; //ident
		var t=this.dstk.get("nums");
		if (t===undefined) throw new Error("dict: nums: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f34(){
		//#line 9735: /numericruns [ msglen {0} repeat 0 ] def
		this.stk[this.ptr++]=0;
	}
	function $f35(){
		//#line 9740: numericruns i numericruns i 1 add get 1 add put
	...
	function $f37(){
		...
		this.ptr--;
		//#line 9739: dup 48 ge exch 57 le and {
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]>=this.stk[this.ptr-1]; this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f38(){
		//#line 9749: pos -1 ne {/mode 3 def exit} if
	...
	function $f39(){
		//#line 9750: numericruns 0 get 5 ge {/mode 2 def exit} if
		this.stk[this.ptr++]="mode"; //ident
		this.stk[this.ptr++]=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		return -1;
	...
	function $f40(){
		//#line 9752: dup type /arraytype ne {pop /mode 0 def exit} if
		this.ptr--;
		this.stk[this.ptr++]="mode"; //ident
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	...
	function $f41(){
		//#line 9753: 0 get 43 eq {4} {5} ifelse /mode exch def
		this.stk[this.ptr++]=4;
	}
	function $f42(){
		//#line 9753: 0 get 43 eq {4} {5} ifelse /mode exch def
	...
	function $f43(){
		...
		//#line 9751: charvals msg 0 get get
		var t=this.dstk.get("charvals");
		if (t===undefined) throw new Error("dict: charvals: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("msg");
	...
	function $f45(){
		//#line 9762: mode 0 eq mode 1 eq or {/method (alpha) def /i 0 def /j 0 def} if 
	...
	function $f46(){
		//#line 9763: mode 2 eq {/method (numeric) def /i 0 def /j 0 def} if
		this.stk[this.ptr++]="method"; //ident
	...
	function $f47(){
		//#line 9775: cws 0 0 1 43 {dup posval exch get pos ne {pop} if} for 1 add put
		this.ptr--;
	}
	function $f48(){
		//#line 9775: cws 0 0 1 43 {dup posval exch get pos ne {pop} if} for 1 add put
	...
	function $f49(){
		...
		this.ptr-=3;
		//#line 9776: /method (alpha) def /i 0 def /j 1 def
		this.stk[this.ptr++]="method"; //ident
		this.stk[this.ptr++]=BWIPJS.psstring("alpha");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="i"; //ident
	...
	function $f50(){
		//#line 9779: cws 0 charvals msg 0 get get 1 get put
		var t=this.dstk.get("cws");
		if (t===undefined) throw new Error("dict: cws: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=0;
		...
		this.ptr-=3;
		//#line 9780: /method (alpha) def /i 1 def /j 1 def
		this.stk[this.ptr++]="method"; //ident
		this.stk[this.ptr++]=BWIPJS.psstring("alpha");
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="i"; //ident
	...
	function $f51(){
		//#line 9785: i msglen eq {exit} if
		return -1;
	}
	function $f52(){
		//#line 9789: ns encodealpha
	...
	function $f53(){
		//#line 9788: numericruns i get 5 ge {
		var t=this.dstk.get("numericruns");
		if (t===undefined) throw new Error("dict: numericruns: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		//#line 9793: msg i get encodealpha
		var t=this.dstk.get("msg");
		if (t===undefined) throw new Error("dict: msg: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f55(){
		//#line 9798: numericruns i get 5 lt {
		var t=this.dstk.get("numericruns");
		if (t===undefined) throw new Error("dict: numericruns: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		//#line 9803: msg i numericruns i get getinterval encodenumeric
		var t=this.dstk.get("msg");
		if (t===undefined) throw new Error("dict: msg: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		//#line 9804: /i i numericruns i get add def
		this.stk[this.ptr++]="i"; //ident
		var t=this.dstk.get("i");
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f57(){
		...
		//#line 9786: {  % not a loop but common exit point
	...
	function $f58(){
		//#line 9831: urows 0 ne urows r ne and {/okay false def} if
		this.stk[this.ptr++]="okay"; //ident
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f59(){
		//#line 9832: cws length dcws gt {/okay false def} if
		this.stk[this.ptr++]="okay"; //ident
		this.stk[this.ptr++]=false;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f60(){
		//#line 9833: okay {exit} if
		return -1;
	}
	function $f61(){
		//#line 9827: /m metrics i get def
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9828: /r    m 0 get def        % Columns in symbol
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9829: /dcws m 1 get def        % Data codewords in symbol
	...
	function $f62(){
		//#line 9838: /cws [ cws aload pop dcws cws length sub {48} repeat ] def
		this.stk[this.ptr++]=48;
	}
	function $f63(){
		//#line 9847: ccs i 8 mul 7 add 0 cc {add} forall 49 mod put
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f64(){
		//#line 9844: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9845: /cc cws j 7 getinterval def
		...
		this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9846: ccs i 8 mul cc putinterval       
	...
	function $f65(){
		//#line 9851: ccs ccs length 8 sub cws j dcws j sub getinterval putinterval
		var t=this.dstk.get("ccs");
		if (t===undefined) throw new Error("dict: ccs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("ccs");
	...
	function $f66(){
		//#line 9868: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9869: ccs i 2 mul get 49 mul ccs i 2 mul 1 add get add 
		var t=this.dstk.get("ccs");
		if (t===undefined) throw new Error("dict: ccs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 9870: weights i 1 add get mul /score exch score add def
	...
	function $f67(){
		//#line 9865: /weights exch def
		this.stk[this.ptr++]="weights"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9866: /score 0 def
		this.stk[this.ptr++]="score"; //ident
		this.stk[this.ptr++]=0;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 9867: 0 1 r 1 sub 8 mul 2 idiv 1 sub {
		this.stk[this.ptr++]=0;
		this.stk[this.ptr++]=1;
		var t=this.dstk.get("r");
		if (t===undefined) throw new Error("dict: r: undefined");
	...
	function $f68(){
		//#line 9878: cr7 weightz 0 get mul weightz calccheck add 2401 mod
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
		//#line 9879: dup 49 idiv exch 49 mod 2 array astore
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		this.stk[this.ptr++]=49;
		this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		...
		t.assign(0,a);
		this.ptr-=t.length;
		//#line 9880: lastrow 0 3 -1 roll putinterval
	...
	function $f69(){
		//#line 9900: ccs ccs length 8 sub 7 getinterval 0 exch {add} forall 49 mod
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	}
	function $f70(){
		//#line 10603: /p i r 1 sub ne {parity i get} {(0000)} ifelse def
	...
	function $f72(){
		//#line 10606: 0 2 7 {ccrow exch 2 getinterval aload pop exch 49 mul add} for
	...
	function $f73(){
		//#line 10612: patterns p j get 48 sub get scrow j get get {48 sub} forall
		this.stk[this.ptr++]=48;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	function $f74(){
		//#line 10611: /j exch def
		this.stk[this.ptr++]="j"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10612: patterns p j get 48 sub get scrow j get get {48 sub} forall
	...
	function $f75(){
		//#line 10617: 1 sbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
		this.stk[this.ptr++]=1;
	}
	function $f76(){
		//#line 10617: 1 sbs {1 index 0 eq {{1}} {{0}} ifelse repeat} forall
	...
	function $f80(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 10604: /ccrow ccs i 8 mul 8 getinterval def
		...
		//#line 10618: counttomark 1 sub array astore exch pop exch pop
		for (var i=this.ptr-1; i>=0 && this.stk[i]!==Infinity; i--);
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.ptr--;
		//#line 10619: rowbits i 3 -1 roll put
	...
	function $f81(){
		//#line 10624: 81 sepheight mul {1} repeat
		this.stk[this.ptr++]=1;
	}
	function $f82(){
		//#line 10627: rowheight {rowbits i get aload pop} repeat
		var t=this.dstk.get("rowbits");
		if (t===undefined) throw new Error("dict: rowbits: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f83(){
		//#line 10628: sepheight {10 {0} repeat 70 {1} repeat 0} repeat
		this.stk[this.ptr++]=0;
	}
	function $f84(){
		//#line 10628: sepheight {10 {0} repeat 70 {1} repeat 0} repeat
	...
	function $f87(){
		//#line 10630: rowheight {rowbits r 1 sub get aload pop} repeat
		var t=this.dstk.get("rowbits");
		if (t===undefined) throw new Error("dict: rowbits: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("r");
	...
	function $f88(){
		//#line 10631: 81 sepheight mul {1} repeat
		this.stk[this.ptr++]=1;
	}
	//#line 9584: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 9586: /options exch def
	this.stk[this.ptr++]="options"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9587: /barcode exch def
	this.stk[this.ptr++]="barcode"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9589: /dontdraw false def
	this.stk[this.ptr++]="dontdraw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9590: /mode -1 def
	this.stk[this.ptr++]="mode"; //ident
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9591: /pos -1 def
	...
	this.stk[this.ptr++]=-1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9592: /rows 0 def
	this.stk[this.ptr++]="rows"; //ident
	this.stk[this.ptr++]=0;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9593: /rowheight 8 def
	this.stk[this.ptr++]="rowheight"; //ident
	this.stk[this.ptr++]=8;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9594: /sepheight 1 def
	this.stk[this.ptr++]="sepheight"; //ident
	this.stk[this.ptr++]=1;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9595: /parse false def
	this.stk[this.ptr++]="parse"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9596: /parsefnc false def
	this.stk[this.ptr++]="parsefnc"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9599: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=BWIPJS.pstype(this.stk[this.ptr-1]);
	...
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9612: /rowheight rowheight cvi def
	this.stk[this.ptr++]="rowheight"; //ident
	var t=this.dstk.get("rowheight");
	if (t===undefined) throw new Error("dict: rowheight: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseInt(this.stk[this.ptr-1],10);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9613: /sepheight sepheight cvi def
	this.stk[this.ptr++]="sepheight"; //ident
	var t=this.dstk.get("sepheight");
	if (t===undefined) throw new Error("dict: sepheight: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 9636: /barlen barcode length def
	...
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9639: /s1 -1 def /s2 -2 def /fn1 -3 def /fn2 -4 def /fn3 -5 def /ns -6 def
	...
	this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9645: /msg barlen array def
	this.stk[this.ptr++]="msg"; //ident
	var t=this.dstk.get("barlen");
	if (t===undefined) throw new Error("dict: barlen: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 9661: /msg msg 0 j getinterval def
	this.stk[this.ptr++]="msg"; //ident
	var t=this.dstk.get("msg");
	if (t===undefined) throw new Error("dict: msg: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9662: /msglen msg length def
	...
	//#line 9667: (A) (B) (C) (D) (E) (F) (G) (H) (I) (J) (K) (L) (M)
	...
	//#line 9668: (N) (O) (P) (Q) (R) (S) (T) (U) (V) (W) (X) (Y) (Z)
	...
	this.stk[this.ptr++]=BWIPJS.psstring("+");
	this.stk[this.ptr++]=BWIPJS.psstring("%");
	//#line 9670: s1  s2  fn1 fn2 fn3 ns
	var t=this.dstk.get("s1");
	if (t===undefined) throw new Error("dict: s1: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("s2");
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9674: /charvals 49 dict def
	...
	//#line 9684: [ (1 ) (1A) (1B) (1C) (1D) (1E) (1F) (1G) (1H) (1I) (1J) (1K) (1L) (1M) (1N) (1O)
	...
	//#line 9758: /cws msglen 2 mul 1 add array def
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9759: /method (alpha) def /i -1 def /j -1 def
	this.stk[this.ptr++]="method"; //ident
	this.stk[this.ptr++]=BWIPJS.psstring("alpha");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="i"; //ident
	...
	//#line 9778: mode 4 eq mode 5 eq or {
	var t=this.dstk.get("mode");
	if (t===undefined) throw new Error("dict: mode: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=4;
	...
	//#line 9809: /cws cws 0 j getinterval def
	this.stk[this.ptr++]="cws"; //ident
	var t=this.dstk.get("cws");
	if (t===undefined) throw new Error("dict: cws: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9841: /ccs r 8 mul array def
	...
	//#line 9855: /cr7 r 2 sub 7 mul mode add def
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9856: ccs ccs length 2 sub cr7 put
	var t=this.dstk.get("ccs");
	if (t===undefined) throw new Error("dict: ccs: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("ccs");
	...
	this.ptr-=3;
	//#line 9859: [  1  9 31 26  2 12 17 23 37 18 22  6 27 44 15 43 39
	...
	//#line 9861: dup [ exch 20 exch 0 32 getinterval aload pop ] /weightx exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	this.stk[this.ptr++]=Infinity;
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.stk[this.ptr++]=20;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9862: dup [ exch 16 exch 1 32 getinterval aload pop ] /weighty exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	this.stk[this.ptr++]=Infinity;
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9863: [ exch 38 exch 2 32 getinterval aload pop ] /weightz exch def
	this.stk[this.ptr++]=Infinity;
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	//#line 9873: } bind def
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9874: /lastrow ccs ccs length 8 sub 8 getinterval def
	...
	//#line 9882: /wr1 lastrow 0 get 49 mul lastrow 1 get add def
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9885: cr7 weighty 0 get mul weighty calccheck add 
	var t=this.dstk.get("cr7");
	if (t===undefined) throw new Error("dict: cr7: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	//#line 9886: wr1 weighty r 4 mul 3 sub get mul add
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	//#line 9887: 2401 mod dup /wr2 exch def
	this.stk[this.ptr++]=2401;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 9888: dup 49 idiv exch 49 mod 2 array astore        
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	this.stk[this.ptr++]=49;
	this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	t.assign(0,a);
	this.ptr-=t.length;
	//#line 9889: lastrow 2 3 -1 roll putinterval
	var t=this.dstk.get("lastrow");
	if (t===undefined) throw new Error("dict: lastrow: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=2;
	...
	this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 9892: cr7 weightx 0 get mul weightx calccheck add
	var t=this.dstk.get("cr7");
	if (t===undefined) throw new Error("dict: cr7: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	//#line 9893: wr1 weightx r 4 mul 3 sub get mul add
	var t=this.dstk.get("wr1");
	if (t===undefined) throw new Error("dict: wr1: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("weightx");
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	//#line 9894: wr2 weightx r 4 mul 2 sub get mul add
	...
	this.stk[this.ptr++]=2401;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	//#line 9896: dup 49 idiv exch 49 mod 2 array astore        
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	this.stk[this.ptr++]=49;
	this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	t.assign(0,a);
	this.ptr-=t.length;
	//#line 9897: lastrow 4 3 -1 roll putinterval
	var t=this.dstk.get("lastrow");
	if (t===undefined) throw new Error("dict: lastrow: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=4;
	...
	this.stk[this.ptr++]=49;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]%this.stk[this.ptr-1]; this.ptr--;
	//#line 9901: ccs ccs length 1 sub 3 -1 roll put
	var t=this.dstk.get("ccs");
	if (t===undefined) throw new Error("dict: ccs: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("ccs");
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 10600: /rowbits r array def
	...
	this.stk[this.ptr++]=81;
	//#line 10639: /pixy pixs length 81 idiv
	...
	this.stk[this.ptr++]=81;
	this.stk[this.ptr-2]=Math.floor(this.stk[this.ptr-2]/this.stk[this.ptr-1]); this.ptr--;
	//#line 10640: /height pixs length 81 idiv 72 div
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 10641: /width 81 72 div
	this.stk[this.ptr++]="width"; //ident
	this.stk[this.ptr++]=81;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 10642: /opt options
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 10645: dontdraw not //renmatrix if
