...
BWIPJS.bwipp["databarexpandedcomposite"]=function() {
	...
	function $f0(){
		//#line 16173: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 16174: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 16176: currentdict end /options exch def
	...
	function $f5(){
		//#line 16178: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 16182: /linear exch def
		this.stk[this.ptr++]="linear"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16183: pop
		this.ptr--;
		//#line 16184: /comp exch def
	...
	function $f9(){
		//#line 16211: sep i 1 sub get 0 eq {1} {0} ifelse
		this.stk[this.ptr++]=1;
	}
	function $f10(){
		//#line 16211: sep i 1 sub get 0 eq {1} {0} ifelse
	...
	function $f12(){
		//#line 16208: bot i 1 sub get 1 eq {
	...
	function $f14(){
		//#line 16206: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16207: bot i get 0 eq {
		var t=this.dstk.get("bot");
		if (t===undefined) throw new Error("dict: bot: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		//#line 16216: sep exch i exch put
		var t=this.dstk.get("sep");
		if (t===undefined) throw new Error("dict: sep: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f15(){
		//#line 16204: /fp exch def
		this.stk[this.ptr++]="fp"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16205: fp 1 fp 12 add {
	...
	function $f16(){
		//#line 16220: 0 linsbs {1 index 1 eq {{0}} {{1}} ifelse repeat} forall
		this.stk[this.ptr++]=0;
	}
	function $f17(){
		//#line 16220: 0 linsbs {1 index 1 eq {{0}} {{1}} ifelse repeat} forall
	...
	function $f21(){
		//#line 16222: /sep [ bot {1 exch sub} forall ] def
		this.stk[this.ptr++]=1;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	...
	function $f24(){
		//#line 16228: ] {sepfinder} forall 
		var t=this.dstk.get("sepfinder");
		if (t===undefined) throw new Error("dict: sepfinder: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	//#line 16162: 20 dict begin            % Confine variables to local scope
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 16164: /options exch def
	this.stk[this.ptr++]="options"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16165: /barcode exch def
	this.stk[this.ptr++]="barcode"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16167: /dontdraw false def
	this.stk[this.ptr++]="dontdraw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16170: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16189: gsave
	this.gsave();
	//#line 16191: options (lintype) (databarexpanded) put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16192: options (linkage) true put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16193: options (inkspread) (0) put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16194: options (dontdraw) true put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16197: linear options //databarexpanded exec
	...
	//#line 16198: dup (sbs) get /linsbs exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16199: dup (bhs) get 0 get 72 mul /linheight exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	//#line 16221: counttomark 1 sub array astore /bot exch def pop pop
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16223: sep 0 [0 0 0] putinterval
	var t=this.dstk.get("sep");
	if (t===undefined) throw new Error("dict: sep: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	//#line 16224: sep sep length 4 sub [0 0 0 0] putinterval
	var t=this.dstk.get("sep");
	if (t===undefined) throw new Error("dict: sep: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("sep");
	...
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 16225: [  % Finder pattern module positions
	this.stk[this.ptr++]=Infinity;
	//#line 16226: 18 98 bot length 13 sub {} for
	...
	//#line 16227: 69 98 bot length 13 sub {} for
	...
	//#line 16229: 0 linheight rmoveto <<
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr++]=1;
	//#line 16234: /height 1 72 div
	this.stk[this.ptr++]="height"; //ident
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16235: /width sep length 72 div
	...
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16236: /opt options
	this.stk[this.ptr++]="opt"; //ident
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 16237: >> //renmatrix exec
	var t = {};
	...
	var t=this.stk[--this.ptr];
	if (t instanceof Function) t.call(this); else this.eval(t);
	//#line 16240: 1 1 rmoveto comp options //gs1-cc exec //renmatrix exec
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=1;
	var y=this.stk[--this.ptr];
	this.rmoveto(this.stk[--this.ptr],y);
