...
BWIPJS.bwipp["databarexpandedstackedcomposite"]=function() {
	...
	function $f0(){
		//#line 16277: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 16278: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 16280: currentdict end /options exch def
	...
	function $f5(){
		//#line 16282: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 16286: /linear exch def
		this.stk[this.ptr++]="linear"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16287: pop
		this.ptr--;
		//#line 16288: /comp exch def
	...
	function $f9(){
		//#line 16315: sep i 1 sub get 0 eq {1} {0} ifelse
		this.stk[this.ptr++]=1;
	}
	function $f10(){
		//#line 16315: sep i 1 sub get 0 eq {1} {0} ifelse
	...
	function $f12(){
		//#line 16312: bot i 1 sub get 1 eq {
	...
	function $f14(){
		//#line 16310: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16311: bot i get 0 eq {
		var t=this.dstk.get("bot");
		if (t===undefined) throw new Error("dict: bot: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		//#line 16320: sep exch i exch put
		var t=this.dstk.get("sep");
		if (t===undefined) throw new Error("dict: sep: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f15(){
		//#line 16308: /fp exch def
		this.stk[this.ptr++]="fp"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 16309: fp 1 fp 12 add {
	...
	function $f16(){
		//#line 16323: /sep [ bot {1 exch sub} forall ] def
		this.stk[this.ptr++]=1;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	}
	...
	//#line 16266: 20 dict begin            % Confine variables to local scope
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 16268: /options exch def
	this.stk[this.ptr++]="options"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16269: /barcode exch def
	this.stk[this.ptr++]="barcode"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16271: /dontdraw false def
	this.stk[this.ptr++]="dontdraw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16274: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 16293: gsave
	this.gsave();
	//#line 16295: options (lintype) (databarexpandedstacked) put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16296: options (linkage) true put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16297: options (inkspread) (0) put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16298: options (dontdraw) true put
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.ptr-=3;
	//#line 16301: linear options //databarexpandedstacked exec
	...
	//#line 16302: dup (pixs) get 0 2 index (pixx) get getinterval /bot exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16303: dup (pixy) get /linheight exch def
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 16324: sep 0 [ 0 0 0 ] putinterval
	var t=this.dstk.get("sep");
	if (t===undefined) throw new Error("dict: sep: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	//#line 16325: sep sep length 4 sub [ 0 0 0 0 ] putinterval
	var t=this.dstk.get("sep");
	if (t===undefined) throw new Error("dict: sep: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("sep");
	...
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 16326: [  % Finder pattern module positions
	this.stk[this.ptr++]=Infinity;
	//#line 16327: 19 98 bot length 13 sub {} for
	...
	//#line 16328: 70 98 bot length 13 sub {} for
	...
	//#line 16330: 0 linheight rmoveto <<
	this.stk[this.ptr++]=0;
	...
	this.stk[this.ptr++]=1;
	//#line 16335: /height 1 72 div
	this.stk[this.ptr++]="height"; //ident
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16336: /width sep length 72 div
	...
	this.stk[this.ptr++]=72;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	//#line 16337: /opt options
	this.stk[this.ptr++]="opt"; //ident
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	//#line 16338: >> //renmatrix exec
	var t = {};
	...
	var y=this.stk[--this.ptr];
	this.rmoveto(this.stk[--this.ptr],y);
	//#line 16342: comp options //gs1-cc exec //renmatrix exec
