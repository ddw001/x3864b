...
BWIPJS.bwipp["pharmacode2"]=function() {
	...
	function $f0(){
		//#line 5601: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 5602: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 5604: currentdict end /options exch def
	...
	function $f5(){
		//#line 5606: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 5613: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 5614: txt i [barcode i 1 getinterval 0 0 () 0] put
	...
	function $f8(){
		...
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		//#line 5630: [3 1 2] exch get val exch sub 3 idiv /val exch def
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 5631: encstr i [2 0 1] 4 -1 roll get put
	...
	function $f9(){
		//#line 5638: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 5639: encstr i get dup
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
		//#line 5640: bhs i bar [1 1 2] 5 -1 roll get mul put
		...
		this.ptr-=3;
		//#line 5641: bbs i [0 bar 0] 4 -1 roll get put
	...
	function $f10(){
		//#line 5649: /sbs [encstr length 2 mul {spc} repeat]
		var t=this.dstk.get("spc");
		if (t===undefined) throw new Error("dict: spc: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	}
	//#line 5588: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 5590: /options exch def           % We are given an option string
	this.stk[this.ptr++]="options"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5591: /barcode exch def           % We are given a barcode string
	this.stk[this.ptr++]="barcode"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5593: /dontdraw false def
	this.stk[this.ptr++]="dontdraw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5594: /includetext false def      % Enable/disable text
	this.stk[this.ptr++]="includetext"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5595: /height 4 def               % Height of short bars in millimetres
	this.stk[this.ptr++]="height"; //ident
	this.stk[this.ptr++]=4;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5598: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 5608: /height height cvr def
	this.stk[this.ptr++]="height"; //ident
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5611: /txt barcode length array def
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5612: 0 1 barcode length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("barcode");
	if (t===undefined) throw new Error("dict: barcode: undefined");
	...
	//#line 5617: /encstr 16 string def
	this.stk[this.ptr++]="encstr"; //ident
	this.stk[this.ptr++]=16;
	this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5618: /bhs 16 array def
	this.stk[this.ptr++]="bhs"; //ident
	this.stk[this.ptr++]=16;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5619: /bbs 16 array def
	this.stk[this.ptr++]="bbs"; //ident
	this.stk[this.ptr++]=16;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5620: /sbs 32 array def
	this.stk[this.ptr++]="sbs"; //ident
	this.stk[this.ptr++]=32;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5621: /bar 1 25.4 div height mul def     % bar height (mm)
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5622: /spc 1 25.4 div 72 mul def         % bar width & spacing (1mm)
	...
	//#line 5634: /encstr encstr i 1 add 15 i sub getinterval def
	this.stk[this.ptr++]="encstr"; //ident
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 5637: 0 1 encstr length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 5656: dontdraw not //renlinear if
