...
BWIPJS.bwipp["auspost"]=function() {
	...
	function $f0(){
		//#line 7013: token false eq {exit} if dup length string cvs (=) search
		return -1;
	}
	function $f1(){
		//#line 7014: true eq {cvlit exch pop exch def} {cvlit true def} ifelse
	...
	function $f4(){
		...
		//#line 7016: currentdict end /options exch def
	...
	function $f5(){
		//#line 7018: options {def} forall
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f6(){
		//#line 7043: barcode 0 2 getinterval (11) eq {37} if
		this.stk[this.ptr++]=37;
	}
	function $f7(){
		//#line 7044: barcode 0 2 getinterval (45) eq {37} if
		this.stk[this.ptr++]=37;
	}
	function $f8(){
		//#line 7045: barcode 0 2 getinterval (59) eq {52} if
		this.stk[this.ptr++]=52;
	}
	function $f9(){
		//#line 7046: barcode 0 2 getinterval (62) eq {67} if
		this.stk[this.ptr++]=67;
	}
	function $f10(){
		//#line 7055: /i exch def       
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7056: encs barcode i 1 getinterval cvi 64 add get
		...
		this.ptr--;
		//#line 7057: encstr i 2 mul 2 add 3 2 roll putinterval
	...
	function $f11(){
		//#line 7062: /i exch def       
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7063: encs barcode i 1 getinterval cvi 64 add get
		var t=this.dstk.get("encs");
		if (t===undefined) throw new Error("dict: encs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("barcode");
		...
		this.ptr--;
		//#line 7064: encstr i 2 mul 2 add 3 2 roll putinterval
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 7065: txt i 2 sub [barcode i 1 getinterval i 2 sub 2 mul 6 add 3.312 mul textyoffset textfont textsize] put
	...
	function $f12(){
		//#line 7071: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7072: encs barcode i 10 add 1 getinterval cvi 64 add get
		var t=this.dstk.get("encs");
		if (t===undefined) throw new Error("dict: encs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("barcode");
		...
		this.ptr--;
		//#line 7073: encstr i 2 mul 22 add 3 2 roll putinterval
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.stk.splice.apply(this.stk, [this.ptr-t.length, 0].concat(t));
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 7074: txt i 8 add [barcode i 10 add 1 getinterval i 2 mul 22 add 3.312 mul textyoffset textfont textsize] put
		var t=this.dstk.get("txt");
		if (t===undefined) throw new Error("dict: txt: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f13(){
		...
		//#line 7076: /ciflen barlen 10 sub 2 mul def
	...
	function $f14(){
		//#line 7079: /i exch def           
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7080: barcode i 10 add 1 getinterval barchars exch search
		var t=this.dstk.get("barcode");
		if (t===undefined) throw new Error("dict: barcode: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		//#line 7081: pop                                
		this.ptr--;
		//#line 7082: length /indx exch def           
		if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
		this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
		...
		this.ptr--;
		this.ptr--;
		//#line 7084: /enc encs indx get def          
		...
		this.ptr--;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7085: encstr i 3 mul 22 add enc putinterval
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
		//#line 7086: txt i 8 add [barcode i 10 add 1 getinterval i 3 mul 22 add 3.312 mul textyoffset textfont textsize] put
		var t=this.dstk.get("txt");
		if (t===undefined) throw new Error("dict: txt: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f15(){
		...
		//#line 7088: /ciflen barlen 10 sub 3 mul def
		this.stk[this.ptr++]="ciflen"; //ident
		var t=this.dstk.get("barlen");
		if (t===undefined) throw new Error("dict: barlen: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f16(){
		//#line 7093: encstr exch encs 75 get putinterval
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f17(){
		//#line 7098: rstable 0 [ 64 {0} repeat ] putinterval
		this.stk[this.ptr++]=0;
	}
	function $f18(){
	}
	function $f19(){
		//#line 7104: /next next 67 xor def
	...
	function $f20(){
		//#line 7108: /nextcell {rstable 64 next mul j add} def
	...
	function $f21(){
		//#line 7111: nextcell nextcell get 67 xor put
	...
	function $f22(){
		...
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7109: nextcell rstable 64 prev mul j add get 1 bitshift put
		var t=this.dstk.get("nextcell");
		if (t===undefined) throw new Error("dict: nextcell: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("rstable");
		...
		this.ptr-=3;
		//#line 7110: nextcell get 64 and 0 ne {
		var t=this.dstk.get("nextcell");
		if (t===undefined) throw new Error("dict: nextcell: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
	...
	function $f23(){
		//#line 7102: /next prev 1 bitshift def
		this.stk[this.ptr++]="next"; //ident
		var t=this.dstk.get("prev");
		if (t===undefined) throw new Error("dict: prev: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f24(){
		//#line 7119: rscodes 0 [ 4 {0} repeat ] putinterval
		this.stk[this.ptr++]=0;
	}
	function $f25(){
		//#line 7121: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7122: rscodes rscodes length i 2 sub 3 idiv sub 1 sub
		...
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		//#line 7123: encstr i 1 getinterval cvi 16 mul
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		//#line 7124: encstr i 1 add 1 getinterval cvi 4 mul add
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		//#line 7125: encstr i 2 add 1 getinterval cvi add        
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f26(){
		//#line 7131: /j exch def
		this.stk[this.ptr++]="j"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7132: rscodes i j add rscodes i j add get
		var t=this.dstk.get("rscodes");
		if (t===undefined) throw new Error("dict: rscodes: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr--;
		//#line 7133: rstable 64 [48 17 29 30 1] j get mul rscodes i 4 add get add get
		var t=this.dstk.get("rstable");
		if (t===undefined) throw new Error("dict: rstable: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=64;
	...
	function $f28(){
		//#line 7139: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7140: /enc rscodes 3 i sub get 4 3 string cvrs def
		this.stk[this.ptr++]="enc"; //ident
		var t=this.dstk.get("rscodes");
		if (t===undefined) throw new Error("dict: rscodes: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7141: checkcode i 3 mul 3 enc length sub add enc putinterval
	...
	function $f29(){
		//#line 7154: bbs i 0 height mul 8 div put
		...
		this.ptr-=3;
		//#line 7155: bhs i 8 height mul 8 div put
	...
	function $f30(){
		//#line 7158: bbs i 3 height mul 8 div put
		var t=this.dstk.get("bbs");
		if (t===undefined) throw new Error("dict: bbs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr-=3;
		//#line 7159: bhs i 5 height mul 8 div put
		var t=this.dstk.get("bhs");
		if (t===undefined) throw new Error("dict: bhs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f31(){
		//#line 7162: bbs i 0 height mul 8 div put
		var t=this.dstk.get("bbs");
		if (t===undefined) throw new Error("dict: bbs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr-=3;
		//#line 7163: bhs i 5 height mul 8 div put
		var t=this.dstk.get("bhs");
		if (t===undefined) throw new Error("dict: bhs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f32(){
		//#line 7166: bbs i 3 height mul 8 div put
		var t=this.dstk.get("bbs");
		if (t===undefined) throw new Error("dict: bbs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		...
		this.ptr-=3;
		//#line 7167: bhs i 2 height mul 8 div put
		var t=this.dstk.get("bhs");
		if (t===undefined) throw new Error("dict: bhs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
	...
	function $f33(){
		//#line 7151: /i exch def
		this.stk[this.ptr++]="i"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		//#line 7152: /enc encstr i 1 getinterval def
		this.stk[this.ptr++]="enc"; //ident
		var t=this.dstk.get("encstr");
		if (t===undefined) throw new Error("dict: encstr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f34(){
		//#line 7176: /sbs [bhs length 1 sub {1.44 1.872} repeat 1.44]
	...
	//#line 6996: 20 dict begin
	this.stk[this.ptr++]=20;
	this.stk[this.ptr-1]={};
	this.dict=this.stk[--this.ptr]; this.dstk.push(this.dict);
	//#line 6998: /options exch def              % We are given an option string
	this.stk[this.ptr++]="options"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 6999: /barcode exch def              % We are given a barcode string
	this.stk[this.ptr++]="barcode"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7001: /dontdraw false def
	this.stk[this.ptr++]="dontdraw"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7002: /includetext false def         % Enable/disable text
	this.stk[this.ptr++]="includetext"; //ident
	this.stk[this.ptr++]=false;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7003: /textfont /Courier def
	this.stk[this.ptr++]="textfont"; //ident
	this.stk[this.ptr++]="Courier"; //ident
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7004: /textsize 10 def
	this.stk[this.ptr++]="textsize"; //ident
	this.stk[this.ptr++]=10;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7005: /textyoffset -7 def
	this.stk[this.ptr++]="textyoffset"; //ident
	this.stk[this.ptr++]=-7;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7006: /height 0.175 def
	this.stk[this.ptr++]="height"; //ident
	this.stk[this.ptr++]=0.175;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7007: /custinfoenc (character) def
	this.stk[this.ptr++]="custinfoenc"; //ident
	this.stk[this.ptr++]=BWIPJS.psstring("character");
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7010: options type /stringtype eq {
	var t=this.dstk.get("options");
	if (t===undefined) throw new Error("dict: options: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 7020: /textfont textfont cvlit def
	this.stk[this.ptr++]="textfont"; //ident
	var t=this.dstk.get("textfont");
	if (t===undefined) throw new Error("dict: textfont: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7021: /textsize textsize cvr def
	this.stk[this.ptr++]="textsize"; //ident
	var t=this.dstk.get("textsize");
	if (t===undefined) throw new Error("dict: textsize: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7022: /textyoffset textyoffset cvr def
	this.stk[this.ptr++]="textyoffset"; //ident
	var t=this.dstk.get("textyoffset");
	if (t===undefined) throw new Error("dict: textyoffset: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-1]=parseFloat(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7023: /height height cvr def
	this.stk[this.ptr++]="height"; //ident
	var t=this.dstk.get("height");
	if (t===undefined) throw new Error("dict: height: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	//#line 7027: [ (000) (001) (002) (010) (011) (012) (020) (021)
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7040: /barchars (ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz #) def
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7042: /barlen barcode length def
	...
	//#line 7047: /encstr exch string def
	this.stk[this.ptr++]="encstr"; //ident
	var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	this.stk[this.ptr-1]=BWIPJS.psstring(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7048: /txt barlen 2 sub array def
	this.stk[this.ptr++]="txt"; //ident
	var t=this.dstk.get("barlen");
	if (t===undefined) throw new Error("dict: barlen: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7051: encstr 0 encs 74 get putinterval
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=0;
	...
	//#line 7069: custinfoenc (numeric) eq {
	...
	//#line 7092: 22 ciflen add 1 encstr length 14 sub {        
	this.stk[this.ptr++]=22;
	...
	//#line 7097: /rstable 64 64 mul array def
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 7099: rstable 64 [ 0 1 63 {} for ] putinterval
	var t=this.dstk.get("rstable");
	if (t===undefined) throw new Error("dict: rstable: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=64;
	...
	//#line 7118: /rscodes encstr length 16 sub 3 idiv 4 add array def
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 7120: 2 3 encstr length 16 sub {
	this.stk[this.ptr++]=2;
	this.stk[this.ptr++]=3;
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	...
	//#line 7128: rscodes length 5 sub -1 0 {
	var t=this.dstk.get("rscodes");
	if (t===undefined) throw new Error("dict: rscodes: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	if (typeof(this.stk[this.ptr-1].length)!=="number") throw "length: invalid: " + BWIPJS.pstype(this.stk[this.ptr-1]);
	...
	//#line 7137: /checkcode (000000000000) 12 string copy def
	...
	//#line 7145: encstr encstr length 14 sub checkcode putinterval
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("encstr");
	...
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 7146: encstr encstr length 2 sub encs 74 get putinterval 
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	var t=this.dstk.get("encstr");
	...
	this.ptr--;
	this.stk[this.ptr-3].assign(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=3;
	//#line 7148: /bbs encstr length array def    
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7149: /bhs encstr length array def
	...
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	//#line 7150: 0 1 encstr length 1 sub {
	this.stk[this.ptr++]=0;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("encstr");
	if (t===undefined) throw new Error("dict: encstr: undefined");
	...
	this.ptr = i;
	this.stk[this.ptr++]=t;
	//#line 7183: dontdraw not //renlinear if
